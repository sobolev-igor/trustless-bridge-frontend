  ...
  const handleBridgeClick = React.useCallback(() => {
    sendBridgeTx(
      ...
      (receipt) => {
        ...
        getProofFromReceipt(web3Instance, receipt)
      },
      () => {
            ...
            <Container>
              <FrameContainer>
                ...
                <Heading3 style={{ marginTop: '10px', marginBottom: '20px' }}>
                  {numberWithCommas(
                    parseFloat(getDisplayValue(balance)).toFixed(3)
                  )}
                  {' '}
                  ETH
                </Heading3>
                  ...
                  txHashClaim === null ? (
                    <>
                      ...
                      <Heading3Green style={{ marginTop: '10px', marginBottom: '20px', }}>
                        {'+'}{numberWithCommas(
                        parseFloat(getDisplayValue(value)).toFixed(3)
                      )}
                        {' '}
                        ETH
                      </Heading3Green>
